class TmpsController < ApplicationController
  before_action :set_tmp, only: %i[ show edit update destroy ]

  # GET /tmps or /tmps.json
  def index
    @tmps = Tmp.all
  end

  # GET /tmps/1 or /tmps/1.json
  def show
  end
  ...
  # PATCH/PUT /tmps/1 or /tmps/1.json
  def update
    respond_to do |format|
