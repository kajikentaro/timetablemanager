...
<html lang="ja">
    <head>
        <title><?php echo $_GET['humanName'];?>の時間割</title>
        <meta charset="utf-8">
    ...
    <body>
        <header>
        <h1 class="title"><?php echo $_GET['humanName'];?>の時間割</h1>
        </header>
        <div class="contents">
        <div class="twobutton">
                <button onclick="backHome()">最初に戻る</button><button class="buttonDel" onclick="mydelete()">この時間割を削除</button>
            </div>
        ...
        <div class="contents timetable">
       <div  id="row0" class="dates">
            <div class="space"></div>
